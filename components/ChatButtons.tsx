...
// Line + WhatsApp click-to-chat with the listing pre-filled — Thai clients
// overwhelmingly prefer LINE over email, so this sits right under the price.
export default function ChatButtons({
  ...
  const { t } = useLang();
  const message = t("chatPrefill", { title, price, url });

  const lineHref = `https://line.me/R/oaMessage/${encodeURIComponent(LINE_OA_ID)}/?${encodeURIComponent(message)}`;

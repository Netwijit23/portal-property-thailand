    ...
    <section className="bg-white border-y border-[#E8E4DC] py-20 md:py-24">
      <div className="max-w-4xl mx-auto px-6 text-center">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 mt-10 font-sans text-[11px] uppercase tracking-[2px] text-[#8A8680] hover:text-[#B8935A] transition-colors pb-1 border-b border-[#E8E4DC] hover:border-[#B8935A]"
        >
